...
banner = color.bblue+'''
    ...
    |    // _ \\ '_ \\ / _ \\/ __|
    | |\\ \  __/ |_) | (_) \__ \\
    \\_| \\_\\___| .__/ \\___/|___/v1.0
              | |    
              |_|      
'''+color.bred+"[x] Information Github Repostories!\n"+color.bheader+"____________Cyber Knight___________\n"+color.white+"\t---------3P1C---------"
from urllib.request import urlopen

def about():
    print(color.byellow+"Author Name  →  3P1C")
    print(color.bred+"Author is a bug bunter,web developer.\n\t\tandroid developer")
    print(color.bblue+"Unkown"+color.white+'')
    
def ver():
    print(color.bheader+"Repos Verson v1.0")
...
try:
    ...
    Command Option: 
        ...
        Example : python repos.py -u mr-malware
                  python repos.py -r mr-malware
        '''
        print(banner)
        usage()
        ...
        print(banner)
        print(color.byellow+" \n[°] Information Gethering Starting.....")
        #api2 = api+sys.argv[2]
    #    apt = urlopen(api2).read().decode('UTF-8')
        #print(apt)
        rep1()
